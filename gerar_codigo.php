...
<html>
    ...
    <body>
        ...
        <br><h1 class="text-center">Gerar Código resgatável</h1>
        <?php
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">   
                	<form action="codigo.php" method="post" class="form-group">
                		<label>Valor:</label>
                		...
                		<br>
                		<input type="submit" name="gerar" class="btn btn-block btn-danger" value="Gerar Código">
                	</form>
                </div>  
                <div class="col-md-4"></div>
            </div>
